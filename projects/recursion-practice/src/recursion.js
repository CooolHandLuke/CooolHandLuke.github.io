...
var range = function(x, y, outputRange = []) {
  //Conditional if statement to determine if x is greater than y
  //If so return range with
  //Base case
...
//   }
//   reverseString.push(string[string.length -1]);
//   return reverse(string.pop());
// };
